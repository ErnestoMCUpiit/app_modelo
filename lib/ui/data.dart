List<String> data = [
  "En 1836, Samuel Colt patentó el primer revólver de seis tiros, lo que cambió por completo la forma en que los soldados y civiles podían defenderse, ya que antes era necesario recargar después de cada disparo",
